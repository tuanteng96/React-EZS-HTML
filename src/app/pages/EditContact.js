                        ...
                        <div className="tab-content pt-5">
                            <div className="tab-pane px-7 active">
                                <form className="form">
                                    ...
                                    <div className="form-group row align-items-center">
                                        <label htmlFor="username" className="col-xl-3 col-lg-3 col-3 col-sm-2 col-form-label text-left text-lg-right">Họ và tên</label>
                                        <div className="col-lg-9 col-xl-6 col-9 col-sm-10">
                                            <input id="username" className="form-control" type="text" defaultValue="Trung Hiếu" />
                                        </div>
                                    </div>
                                    <div className="form-group row align-items-center">
                            ...
                            <div className="col-lg-9 col-xl-6">
                                <div className="dropdown bootstrap-select form-control">
                                    ...
                                    <div className="form-group row align-items-center">
                                        <label htmlFor="phone-number" className="col-xl-3 col-lg-3 col-sm-2 col-3 col-form-label text-left text-lg-right">Số điện thoại</label>
                                        <div className="col-lg-9 col-xl-6 col-sm-10 col-9">
                                            <div className="input-group">
                                                ...
                                                <input id="phone-number" type="text" className="form-control" defaultValue="0981.883.338" placeholder="Phone" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="form-group row align-items-center">
                                        <label htmlFor="email" className="col-xl-3 col-lg-3 col-sm-2 col-3 col-form-label text-left text-lg-right">Email</label>
                                        <div className="col-lg-9 col-xl-6 col-sm-10 col-9">
                                            <div className="input-group">
                                                <div className="input-group-prepend">
                                                    <span className="input-group-text">
                                                ...
                                                <input id="email" type="email" className="form-control" defaultValue="ngoclb@ezs.vn" placeholder="Email" />
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div className="card-footer">
                        <div className="row">
                            <div className="col-9 offset-3 px-7">
                                <button type="button" className="btn btn-success">Lưu thay đổi</button>
                            </div>
                        </div>
                    </div>
                </div>
