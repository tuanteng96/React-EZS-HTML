          ...
          <div className="datatable datatable-default">
            <div className="overflow-hidden">
              <table className="table table-head-custom overflow-hidden table-responsive-custom custom">
                ...
                <tbody>
                  <tr>
                    <td data-title="STT" className="d-none d-lg-block py-9">
                    ...
                    <td data-title="Khách hàng">
                      <div className="d-flex align-items-center py-3 py-3-sm">
                        ...
                        <div className="ml-4 w-100">
                          ...
                          <a
                            href="#"
                            className="text-muted font-weight-bold text-hover-primary mb-3"
                          >
                            lcarnall9f@alexa.com
                          </a>
                          <div className="d-lg-none">
                            ...
                            <div className="mt-3">
                              <span class="label label-lg font-weight-bold btn btn-info label-inline label-square">
                                F
                              </span>
                              <span className="label btn btn-success label-lg font-weight-bold label-inline label-square">
                                12/02/2022
                              </span>
                            </div>
                            <div className="mt-3 d-flex d-sm-flex align-items-center mt-3">
                              <span className="label-lg font-weight-bold label-inline d-sm-block ml-2">
                                Đang dùng thử
                              </span>
                              <div
                                className="progress-wrap align-items-center d-flex ml-3"
                                style={{ flexBasis: "30%" }}
                              >
                                <div
                    ...
                    <td className="d-none d-lg-table-cell">
                      <div className="d-flex">
                        ...
                        <span className="label btn btn-primary label-lg font-weight-bold label-inline label-square">
                          12/02/2022
                        </span>
                      </div>
                    </td>
                    <td className="d-none d-lg-table-cell">
                      <span className="label-lg font-weight-bold label-inline">
                        Đang dùng thử
                      </span>
                    ...
                    <td>
                      <div className="dropdown dropdown-inline d-sm-flex align-items-sm-center">
                        <a
                          href="javascript:;"
                          class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2 btn-size"
                  ...
                  <tr>
                    <td data-title="STT" className="d-lg-block d-none py-9">
                        ...
                        <div className="ml-4 w-100">
                          ...
                          <div className="d-lg-none">
                            ...
                            <div className="mt-3">
                              ...
                              <span
                                className={`label btn btn-success label-lg font-weight-bold label-inline label-square`}
                              >
                                12/02/2022
                              </span>
                            </div>
                            <div className="d-flex d-sm-flex align-items-center mt-3">
                              <span className="label-lg font-weight-bold label-inline d-sm-block ml-2">
                                Đang dùng thử
                              </span>
                              <div
                    ...
                    <td className="d-none d-lg-table-cell">
                      <div className="d-flex">
                        ...
                        <span className="label btn btn-danger label-lg font-weight-bold label-inline label-square">
                          12/02/2020
                        </span>
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td className="d-none d-lg-table-cell">
                      <div className="d-flex">
                        ...
                        <span className="label btn btn-warning label-lg font-weight-bold label-inline label-square">
                          12/02/2021
                        </span>
                      </div>
                    </td>
